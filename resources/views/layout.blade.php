...
<html lang="vi">
   <head>
     ...
     <!-- Latest compiled and minified CSS -->
      ...
      <link href="frontend/css/cubeportfolio.min.css" rel="stylesheet"
         type="text/css"/>
   ...
   <body class="c-layout-header-fixed c-layout-header-mobile-fixed c-layout-header-topbar c-layout-header-topbar-collapse">
            ...
            <div id="slider" class="owl-theme section section-cate slideshow_full_width ">
               ...
               <div id="slide_banner" class="owl-carousel">
                  ...
                  <div class="item">
                     ...
                     <img src="{{asset('/uploads/slider/'.$sli->images)}}" width="100%" height="450px" alt="{{$sli->title}}">
                     </a>
                  </div>
                  @endforeach
               </div>
        ...
        @yield('content')
         ...
         <div class="modal fade" id="noticeModal" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog" role="document">
               <div class="loader" style="text-align: center"><img src="/assets/{{asset('frontend/images/loader.gif')}}"
      ...
      <div class="modal fade" id="LoadModal" role="dialog" style="display: none;" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="loader" style="text-align: center"><img src="/assets/{{asset('/images/loader.gif')}}"
               style="width: 50px;height: 50px;display: none"></div>
            <div class="modal-content">
            </div>
         </div>
         ...
         $(document).ready(function () {
             $('.load-modal').each(function (index, elem) {
                 $(elem).unbind().click(function (e) {
                     ...
                     curModal.find('.modal-content').html("<div class=\"loader\" style=\"text-align: center\"><img src=\"/assets/{{asset('/images/loader.gif')}}\" style=\"width: 50px;height: 50px;\"></div>");
