...
<div class="c-content-box c-size-lg c-overflow-hide c-bg-white">
      ...
      <div class="container m-t-20 content_post">
         ...
         <p>
            <a rel="gallery1" data-fancybox="images" href="{{asset('/uploads/gallery/'.$gall->images)}}">
            <img class="img-responsive img-thumbnail" alt="{{$gall->title}}" src="{{asset('/uploads/gallery/'.$gall->images)}}" alt="png-image">
            </a>
         </p>
      @endforeach
