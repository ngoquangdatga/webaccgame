...
<div class="c-content-box c-size-md c-bg-white">
            <div class="container">
               ...
               <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
                  ...
                  <div class="item">
                        <a href="{{route('dichvu')}}" ><img src="/frontend/images/vHPm7XyQah_1623147701.jpg" alt="Trang cá nhân nickvn"/></a>
                     </div>
                     <div class="item">
                        <a href="{{route('dichvu')}}" ><img src="frontend/images/vHPm7XyQah_1623147701.jpg" alt="Trang cá nhân nickvn"/></a>
                     </div>
                     ...
                     <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                           <div class="news_image">
                              ...
                              <a href="{{route('danhmucgame',['slug' =>'999jjjjj'])}}" title="{{$cate->title}}" class="">
                              <img src="{{asset('/uploads/category/'.$cate->images)}}" alt="{{$cate->title}}"></a>
                           </div>
                           <div class="news_title">
                              <h2>
                                 <a href="{{route('danhmucgame',['slug' =>$cate->slug])}}" title="{{$cate->title}}">{{$cate->title}}</a>
                              </h2>
                           </div>
